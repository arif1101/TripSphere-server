...
passport_1.default.use(new passport_local_1.Strategy({
    ...
    try {
        ...
        if (isGoogleAuthenticated && !isUserExist.password) {
            return done(null, false, { message: "Your have authenticated through Google. So if you want to login with credentials, then at first login with google and set a password for your Gmail and then you can login with email and password." });
        }
